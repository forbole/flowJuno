...
// DelegatorStaked allows to build a new DelegatorStaked
func NewDelegatorStaked(
	staked uint64,
	height int64,
	nodeId string,
	delegatorId uint32) DelegatorStaked {
	return DelegatorStaked{
		Staked:      staked,
		Height:      height,
		NodeId:      nodeId,
		DelegatorId: delegatorId,
